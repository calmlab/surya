    ...
    try:
        ...
        for file_idx, file in enumerate(files):
            ...
            for page_idx, (image, layout_result) in enumerate(zip(images, layout_results)):
                ...
                # Note: OCR results are in cropped image coordinates, we need to adjust them
                for box_idx, (ocr_result, (_, layout_box)) in enumerate(
                    ...
                    for text_line in ocr_result.text_lines:
                        # Use PolygonBox.shift() method to adjust coordinates
                        # This automatically updates both polygon and bbox (computed field)
